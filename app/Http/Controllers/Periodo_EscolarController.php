...
class Periodo_EscolarController extends Controller
{
    ...
    public function index($js="AJAX")
    {
        ...
        return view('admin.periodo_escolar',['cons' => $cons2, 'num' => $num, 'grado' => $grado2, 'num_grado' => $num_grado, 'seccion' => $seccion2, 'num_seccion' => $num_seccion, 'salon' => $salon2, 'num_salon' => $num_salon, 'js' => $js]);
    }
