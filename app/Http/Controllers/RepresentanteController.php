...
class RepresentanteController extends Controller
{
    ...
    public function index($js="AJAX")
    {
        ...
        return view('admin.representante',['cons' => $cons2, 'num' => $num, 'ocupacion_laboral' => $ocupacion_laboral2, 'num_ocupacion_laboral' => $num_ocupacion_laboral, 'state' => $state2, 'num_state' => $num_state, 'js' => $js]);
    }
