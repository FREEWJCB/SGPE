...
@section('busqueda')
    ...
    <input name="bs_cedula" id="bs_cedula" onkeypress="return numero_e(event)" class="form-control mr-sm-2" type="text" maxlength="8" placeholder="Buscar por cédula" arialabel="Search"/>
...
@section('form')
    ...
    <input type="hidden" value="false" id="representante_v" name="representante_v" />
    ...
    <div style='display: none' id="representant">
        <div class="form-group">
            ...
            <div class="input-group mb-3">
                <input type="text" maxlength="8" class="form-control" onkeypress="return numero_e(event)" placeholder="Buscar por cédula" arialabel="Buscar por cédula" aria-describedby="button-addon2" required id="cedula_r" name="cedula_r" />
                <div  data-turbolinks="false" class="input-group-append">
        ...
        <div style='display: none' id="formu">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    <label for="parroquia_r"><b>Parroquia:</b></label>
                    <select class="form-control" id="parroquia_r" name="parroquia_r">
                        <option value="null" disabled selected>Seleccione un parroquia</option>
                    </select>
                    <small id="parroquia_r_e" style="color: red"></small>
                </div>
            </div>

            <div class="form-group">
                <label for="direccion_r"><b>Dirección:</b></label>
                <textarea class="form-control" required id="direccion_r" name="direccion_r" rows="3"></textarea>
